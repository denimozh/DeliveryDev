...
const AboutUs = () => {
  return (
    <div className='md:px-20 xl:px-40 pt-48 pb-48'>
      <p className='text-7xl text-red-700 font-bold tracking-wider'>A TASTE OF <span className=' text-red-500 '>ASIAN TRADITION</span> <br></br>IN EVERY SERVING</p>
